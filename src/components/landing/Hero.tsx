        ...
        <div className="container mx-auto px-4 text-center md:text-left grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-5 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4">
              <button onClick={() => setShowModal(true)} className="bg-[#FF6B00] text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-bold text-base md:text-lg hover:brightness-110 transition flex justify-center items-center gap-2 md:gap-3">

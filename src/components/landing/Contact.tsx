...
import { Smartphone, Instagram, MapPin } from 'lucide-react'
      ...
      <section id="contato" className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto mb-12">
            <a href={`https://wa.me/${WA}`} className="bg-white dark:bg-gray-800 rounded-2xl p-5 md:p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:border-[#FF6B00] hover:shadow-md transition-all group">
          ...
          <button onClick={() => setShowModal(true)} className="bg-[#FF6B00] text-white px-8 md:px-10 py-3 md:py-4 rounded-xl md:rounded-2xl font-black text-base md:text-lg hover:brightness-110 transition shadow-xl shadow-orange-500/30">
            Solicitar Orçamento
          </button>
        </div>
      </section>

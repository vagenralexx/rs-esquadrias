    ...
    <footer className="bg-white dark:bg-gray-900 py-16 border-t border-gray-100 dark:border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-12 text-center md:text-left mb-12">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start gap-3">
              ...
              <button onClick={() => openModal('footer_whatsapp')} className="w-10 h-10 bg-black dark:bg-gray-800 text-white rounded-full flex items-center justify-center hover:bg-[#25D366] transition" aria-label="WhatsApp">
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Link to="/parceiros" className="text-gray-400 dark:text-gray-500 text-xs hover:text-[#FF6B00] transition uppercase tracking-widest font-bold">Parceiros</Link>

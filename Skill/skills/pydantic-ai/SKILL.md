...
- `@llm-app-patterns` — General LLM application development patterns
- `@tool-design` — Design tool interfaces and structured agent actions
- `@multi-agent-patterns` — Orchestrating multiple PydanticAI agents
